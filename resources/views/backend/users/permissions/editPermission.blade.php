    ...
    <div class="w3-main" style="margin-left:300px;margin-top:43px;">
        ...
        <div class="w3-half w3-padding" style="background: rgba(29,33,36,0.11)">
            ...
            <form class="w3-container" method="post">
                @csrf
                <legend class="w3-text-blue font-effect-3d-float" style="font-family: 'Manuale';">Edit Permission</legend>
                <input class="w3-input w3-animate-input w3-text-sand w3-margin-top" autofocus value="{{$permission->name}}" name="name" id="name" type="text" style="width:135px;background: none;">
                @error('name')
